...
public:
    ...
    void setupUi(QMainWindow *WhatsProgMain)
    {
        ...
        actionNovo_usuario->setObjectName(QStringLiteral("actionNovo_usuario"));
        actionUsuario_existente = new QAction(WhatsProgMain);
        actionUsuario_existente->setObjectName(QStringLiteral("actionUsuario_existente"));
        ...
        tableConversas->setObjectName(QStringLiteral("tableConversas"));
        ...
        tableMensagens->setObjectName(QStringLiteral("tableMensagens"));
        ...
        menuConexao->setObjectName(QStringLiteral("menuConexao"));
    ...
    {
        WhatsProgMain->setWindowTitle(QApplication::translate("WhatsProgMain", "WhatsProg", nullptr));
        ...
        actionNovo_usuario->setText(QApplication::translate("WhatsProgMain", "Novo usu\303\241rio...", nullptr));
        actionUsuario_existente->setText(QApplication::translate("WhatsProgMain", "Usu\303\241rio existente...", nullptr));
        ...
        labelMensagens->setText(QApplication::translate("WhatsProgMain", "NENHUMA CONVERSA SELECIONADA", nullptr));
        ...
        menuConexao->setTitle(QApplication::translate("WhatsProgMain", "Conex\303\243o", nullptr));
    } // retranslateUi
